...
namespace filetrans
{
    ...
    public:
        ...
        bool send_optional_files(Socket::socket_ptr connected_sock);
        bool send_file_context(Socket::socket_ptr connected_sock); // download
        bool recv_file_context(Socket::socket_ptr connected_sock); // upload
